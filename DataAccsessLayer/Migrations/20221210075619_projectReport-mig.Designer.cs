...
namespace DataAccsessLayer.Migrations
{
    ...
    [Migration("20221210075619_projectReport-mig")]
    partial class projectReportmig
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EntityLayer.Concrete.EquipmentMaintenanceUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("EquipmentMaintenanceUser");
                });
            ...
            modelBuilder.Entity("EntityLayer.Concrete.FaultReport", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<DateTime>("Deadline1")
                        .HasColumnType("datetime2");

                    b.Property<DateTime>("Deadline2")
                        .HasColumnType("datetime2");

                    b.Property<DateTime>("Deadline3")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("EntityLayer.Concrete.ProjectReport", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("EntityLayer.Concrete.RobotToBeMaintainedUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("RobotToBeMaintainedUser");
                });
            ...
            modelBuilder.Entity("EntityLayer.Concrete.EquipmentMaintenanceUser", b =>
                {
                    b.HasOne("EntityLayer.Concrete.ProjectEquipment", "ProjectEquipment")
                        .WithMany("EquipmentMaintenanceUsers")
                        .HasForeignKey("ProjectEquipmentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("EntityLayer.Concrete.RobotToBeMaintainedUser", b =>
                {
                    b.HasOne("EntityLayer.Concrete.ProjectRobot", "ProjectRobot")
                        .WithMany("RobotToBeMaintainedUsers")
                        .HasForeignKey("ProjectRobotId");
            ...
            modelBuilder.Entity("EntityLayer.Concrete.ProjectEquipment", b =>
                {
                    ...
                    b.Navigation("EquipmentMaintenanceUsers");
                });
            ...
            modelBuilder.Entity("EntityLayer.Concrete.ProjectRobot", b =>
                {
                    ...
                    b.Navigation("RobotToBeMaintainedUsers");
                });
